...
<form action="<?php echo site_url('auth/department');?>" method='post' name='process'>
            <h2>Move Department</h2>
            <br />            
            <label for='employeeno'>Employee NO</label>
            <input type='text' name='employeeno' id='employeeno'  /><br />
         
            <label for='salarychange'>Move Department To</label>
            <input type='text' name='movedepartment' id='movedepartment'  /><br />                         
        
            <input type='Submit' value='Move Department' />            
        </form>

...
<form name="input" action="<?php echo site_url('find/findempadvance') ?>" method="get">
	
	<a href="http://localhost1/w1173133/index.php/auth/userlogin" target="">Return</a>
	<fieldset>
 ...
 Hire Date: <input type="text" name="hire_date" id="hire_date"><br>
